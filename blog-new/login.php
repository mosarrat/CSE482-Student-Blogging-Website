...
<head>
    ...
    <title>Login | NSUer's Blog</title>
</head>
...
<body>
    ...
    <main class="form-signin">
        <form action="login.php" method="POST" class="mt-5">
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit" name="login-btn">
                Sign in
            </button>
            <div>
                <p class="mt-3">
                    Don't have an account? <a href="<?php echo Base_URL . 'signup.php' ?>" class="text-decoration-none">Sign up</a>
                </p>
            </div>
